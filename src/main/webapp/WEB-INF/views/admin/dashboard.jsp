...
action="filtrar-dashboard" method="post">
				
					<div class="row mb-2">
						<div class="col-md-3">
							<form:input type="date" 
path="model.dataIni" id="dataIni" name="dataIni" class="form-control"/>
						</div>
						<div class="col-md-3">
							<form:input type="date" 
path="model.dataFim" id="dataFim" name="dataFim" class="form-control"/>
						</div>
						<div class="col-md-6">
...
validate/1.19.5/localization/messages_pt_BR.min.js"></script>
	...
	<script>
		$(document).ready(function() {
			...
			dados.push(['Total de Contas a Receber', 
