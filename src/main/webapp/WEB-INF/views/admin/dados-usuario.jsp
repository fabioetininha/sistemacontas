...
<body>
	...
	<jsp:include page="/WEB-INF/views/admin/components/navbar.jsp">
</jsp:include>
	...
	<div class="container mt-3">
		...
		<div class="card">
			<div class="card-body">
				...
				<div>Nome do usuário: 
       <strong>${usuario.nome}</strong></div>
				<div>Email de acesso: 
<strong>${usuario.email}</strong></div>
			</div>
		</div>
...
name="novaSenha" id="novaSenha" class="form-control"/>
						...
						<div class="col-md-3">
							<label>Confirme a nova 
senha:</label>
							<input type="password" 
name="novaSenhaConfirmacao" id="novaSenhaConfirmacao" class="form-control"/>
						</div>
					</div>
...
minlength : 8, maxlength: 20},
					'novaSenhaConfirmacao' : { required: true, 
equalTo : "#novaSenha" }
				}
			});
